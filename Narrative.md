...
<a id="entry-move-qualified-user-intake-storage-to-s3-add-mcp-server-registration-tem"></a>

## Entry 15 — 2026-08-08 — Move qualified-user intake storage to S3; add MCP-server registration template and skill
