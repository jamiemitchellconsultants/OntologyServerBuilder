# Prompt 43 — Add bounded LLM intake analysis

Using the engineer intake workbench from Prompt 36 and the completed offline embedding evidence
from Prompt 42, add a bounded, advisory LLM analysis pass in the separate `OntologyService`
