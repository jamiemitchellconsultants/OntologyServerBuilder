# Prompt 24 — Add ledger and journal semantics informed by XBRL Global Ledger

Using the previously supplied repository contract and the accounting foundation from Prompt 23,
