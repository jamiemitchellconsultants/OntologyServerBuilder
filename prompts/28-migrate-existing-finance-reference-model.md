# Prompt 28 — Migrate the existing finance reference model

Using the previously supplied repository contract and the standards-aligned layers implemented in
Prompts 22–27, migrate the original four-concept finance reference model and its examples onto the
new semantics.
...
- the approved migration inventory from Prompt 21;
...
Preserve these stable IDs unless the Prompt 21 review explicitly found an identity conflict:
