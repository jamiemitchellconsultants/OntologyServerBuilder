# Prompt A-32 — Compile named mapping tools

Using the governed mapping instructions from Prompt C-02 and the current compiled entity and
...
Read Prompts C-02, A-21–A-24, A-31, and B-05; the approved qualified-user intake plan; `AGENTS.md`; Project
...
target repository as it exists. Do not assume Prompt C-12 has registered an accounts-payable system or
...
Integrate descriptors with Prompt B-05's existing release-manifest generator and its optional,
...
- deterministic Prompt B-05 release deltas for added, changed, deprecated, and removed named mapping
...
- Compiled descriptors flow through Prompt B-05's established release-manifest interface, producing
