# Prompt A-24 — Add the engineer intake workbench

Using Prompt A-22's durable `IntakeStore` and Prompt A-23's qualified-user submission contracts, add
...
Read Prompts A-21–A-23; the current `IntakeStore`, S3 adapter, capability authorization, MCP
...
- preservation of existing Prompt A-23 qualified-user tools without adding qualified-user list,
