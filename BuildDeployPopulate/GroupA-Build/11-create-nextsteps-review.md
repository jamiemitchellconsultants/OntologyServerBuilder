# Prompt A-11 — Create the post-build review and next-steps document
...
5. The container host allow-list correction, marked completed only if Prompt B-01 is present in Git
...
7. Reuse/security/contribution policy work, marked completed only if Prompt A-10 is present and the
   files agree.
