# Prompt A-33 — Independently audit the qualified-user workflow

Use this prompt in a fresh coding-agent task, preferably with an independent reviewer, only after
Prompts A-21–A-31, B-05, A-32, and C-12 have been completed in the separate `OntologyService` repository. Do not change
