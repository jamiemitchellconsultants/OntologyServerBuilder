# Prompt C-07 — Remodel procure-to-pay with OASIS UBL alignments

Using the previously supplied repository contract and the accounting core from Prompts C-05–C-06, add
...
- Existing consumers remain functional pending Prompt C-10 migration.
