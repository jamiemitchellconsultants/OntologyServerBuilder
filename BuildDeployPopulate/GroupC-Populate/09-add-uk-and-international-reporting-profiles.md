# Prompt C-09 — Add UK and international accounting-reporting profiles

Using the previously supplied repository contract and the operational accounting model from
Prompts C-05–C-08, add governed, effective-dated reporting profiles for a UK-based group with
...
- the Prompt C-03 reporting strategy and unresolved owner decisions;
