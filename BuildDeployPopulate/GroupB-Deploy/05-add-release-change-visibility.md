# Prompt B-05 — Add deployment release-change visibility

Using the qualified-user intake submission path from Prompt A-23, add deterministic current-release
...
Read Prompts A-21–A-23 and A-31, the approved qualified-user intake plan, `AGENTS.md`, Project Narrative
...
collection with a canonical stable-ID representation. Before Prompt A-32, an artifact with no explicit
...
not suppress the class because the opposite artifact has no collection. Prompt A-32 must later supply
